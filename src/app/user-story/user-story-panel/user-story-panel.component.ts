...
@Component({
  selector: 'app-user-story-panel',
  templateUrl: './user-story-panel.component.html',
  styleUrls: ['./user-story-panel.component.css']
})
export class UserStoryPanelComponent implements OnInit {
